...
LOG_FILE_NAME=os.getenv("LOG_FILE_NAME", "logs/app.log")
...
LOG_PROJECT_NAME=os.getenv("LOG_PROJECT_NAME", "src") # Change to project name if necessary
...
# Researcher Config
RESEARCHER_TASK_RETRY_LIMIT=os.getenv("TASK_RETRY_LIMIT", 3)

# State
CRITIC_MAX_ITERATION=os.getenv("CRITIC_MAX_ITERATION", 3)